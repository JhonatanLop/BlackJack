...
fichas = 1000.00
# esvazia a mesa, a mão do usuário e do oponente
mesa = []
## player ##
user_hand = []
hand_value = 0
...
jogo = input("gostaria de jogar? s/n\n")

# força a String inteira em letras minúsculas
jogo = jogo.lower()
...
while resp == False:
    if jogo == "s":
        ...
        print("startou o programa pq ent porr@ ??")
    else:
